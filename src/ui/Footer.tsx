    ...
    <footer className="bg-gray-200 text-slate-700 p-5 relative z-50">
        <div className="container mx-auto flex flex-col sm:flex-row gap-2 items-center justify-between">
            ...
            <div className="flex gap-2 items-center">
              ...
              <Link href={"#"} className='text-xs text-slate-500 hover:text-slate-900'>Cookie Policy</Link>
              <Link href={"/sitemap.xml"} className='text-xs text-slate-500 hover:text-slate-900'>Sitemap</Link>
            </div>
        </div>
    </footer>
  )
